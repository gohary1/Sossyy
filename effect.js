...
$('document').ready(function(){
	...
	$('#wish_message').click(function(){
     ...
     // Only do the manual pixel positioning if on Desktop (wide screens)
     if (windowWidth > 768) {
         var vw = windowWidth / 2;
         $('#b1').attr('id','b11').animate({top:240, left: vw-400},500);
         $('#b2').attr('id','b22').animate({top:240, left: vw-300},500);
         // ... repeat for b3 through b10 using your original logic ...
     } else {
         // On Mobile, just change the IDs and let CSS Flexbox handle the position!
         $('.balloons').each(function(index){
             $(this).attr('id', 'b' + (index+1) + (index+1)); 
         });
     }
